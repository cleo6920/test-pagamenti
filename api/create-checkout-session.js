...
export default async function handler(req, res) {
  try {
    ...
    // Crea sempre un Customer (come nella tua versione), con dati per prefill
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      // Prefill completo come nella tua versione
      customer: customerId,
